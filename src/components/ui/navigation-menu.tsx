...
const navigationMenuLinkStyle = cva(
  "relative inline-flex w-max items-center px-3 py-3 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus:outline-none cursor-pointer disabled:pointer-events-none disabled:opacity-50 data-[active]:text-foreground after:absolute after:bottom-0 after:left-0 after:h-[3px] after:w-full after:bg-foreground after:opacity-0 after:transition-opacity data-[active]:after:opacity-100"
)
